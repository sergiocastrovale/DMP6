...
struct Args {
    ...
    /// marker (e.g. "v.a.") rewritten to the canonical spelling, then invisible characters stripped
    /// and whitespace trimmed. Never MusicBrainz. Requires a prior --audit (reads its spool).
