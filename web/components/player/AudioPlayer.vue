  ...
  >
    ...
    <div class="flex flex-1 flex-col items-center gap-1">
      ...
      <div class="flex w-full max-w-lg items-center gap-2 text-xs text-zinc-400">
        ...
        >
          <div
            class="h-full rounded-full bg-zinc-50 transition-colors group-hover:bg-amber-500"
    ...
    <!-- Volume -->
    <div class="flex w-1/4 items-end justify-center gap-1">
      <div class="flex items-center gap-2">
        ...
        <input
          ...
          @input="player.setVolume(Number.parseFloat(($event.target as HTMLInputElement).value))"
        />
      </div>
    </div>
  </div>
