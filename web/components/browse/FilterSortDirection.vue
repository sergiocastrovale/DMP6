...
const label = computed(() => (props.direction === 'asc' ? 'Sort ascending' : 'Sort descending'))
</script>
...
<template>
  <UiButton
    variant="quiet"
    icon-only
    :icon="direction === 'asc' ? ArrowUpNarrowWide : ArrowDownWideNarrow"
    :aria-label="label"
    :title="label"
    @click="emit('toggle')"
  />
