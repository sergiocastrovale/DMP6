...
useHead({ title: buildPageTitle('Statistics', 'Missing Cover Art') })
...
<template>
  <StatisticsStatPage title="Missing Cover Art" api-type="missing-art" label="releases" default-sort="title" :columns="columns">
