...
export const layout = {
  ...
  dialogTitle: 'min-w-0 pr-4 pl-5 py-5 flex items-start justify-between gap-4 text-stone-200/55 hover:text-stone-200',
  dialogActions: 'flex items-center justify-end gap-1 border-y bg-stone-800/50 border-stone-100/10 py-1 pl-4 pr-2 mb-5',
  dialogContent: 'flex-1 overflow-y-auto px-5 pb-7',
  dialogFooter: 'flex items-center justify-end gap-2 border-t border-stone-100/10 px-5 py-5',
